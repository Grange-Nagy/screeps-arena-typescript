...
export interface Task {
  ...
  validWorkers: Worker[]; // list of valid worker types for this task, in descending order of priority {mostDesired, ... , leastDesired}
  subtasks?: Task[]; // list of tasks (maybe think about preventing recursion here by making sure isTaskComposition is false for all subtasks), priority should be the same for all subtasks
